    ...
    return (
      ...
      <nav className="navbar navbar-expand-lg navbar-light opacity-90" style={{ backgroundColor: '#BDBDBD', }} >
        <div className="container-fluid">
          <a className="navbar-brand fw-bold text-dark disabled ">Tech Planet</a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link text-dark" href="/PCR">Income</a>
              </li>
              <li className="nav-item">
                <a className="nav-link text-dark " href="/KSHC">Expenses</a>
              </li>
              <li className="nav-item">
                <a className="nav-link text-dark" href="/branches">Suplier Credits</a>
              </li>
              <li className="nav-item">
                <a className="nav-link text-dark" href="/AboutUs">View Reports</a>
              </li>
              {/* <li className="nav-item">
