  ...
  render() {
    return (
      <div className="Khome">
        ...
        <center>
          <h1><span class="badge bg-primary text-WHITE opacity-90 fs-1" style={{marginBlockStart:'-1%'}}>Manage Expenses</span></h1>
        </center>
        <div >
          <br />
          <h3><span class="badge bg-primary text-white opacity-95 ">Expenses Details Table</span></h3>
          <table class="table container table-bordered opacity-100 " >
          ...
          <center>
              <MDBCard shadow='0' border='white' background='white' className='mb-3' class Name="opacity-80" style={{ maxWidth: '22rem' }}>
                <MDBCardBody >

                  <a className="btn btn-primary text-white " href="/showroomadd" >
